...
def ppo_dist_objective(hparams):
    ...
    if rank in range(0, 16):
        ...
        cuda_rank = 'cuda:7'
    elif rank in range(128, 144):
        cuda_rank = 'cuda:8'
    elif rank in range(144, 160):
        cuda_rank = 'cuda:9'
    elif rank in range(160, 176):
        cuda_rank = 'cuda:10'
    elif rank in range(176, 192):
        cuda_rank = 'cuda:11'
    elif rank in range(192, 208):
        cuda_rank = 'cuda:12'
    elif rank in range(208, 224):
        cuda_rank = 'cuda:13'
    elif rank in range(224, 240):
        cuda_rank = 'cuda:14'
    else:
        cuda_rank = 'cuda:15'
