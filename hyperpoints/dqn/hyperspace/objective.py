...
def enduro_dist_dqn(hparams):
    if rank in range(0, 4):
        cuda_rank = 'cuda:0'
    elif rank in range(4, 8):
        cuda_rank = 'cuda:1'
    elif rank in range(8, 12):
        cuda_rank = 'cuda:2'
    elif rank in range(12, 16):
        cuda_rank = 'cuda:3'
    elif rank in range(16, 20):
        cuda_rank = 'cuda:4'
    elif rank in range(20, 24):
        cuda_rank = 'cuda:5'
    elif rank in range(24, 28):
        cuda_rank = 'cuda:6'
    elif rank in range(32, 36):
        cuda_rank = 'cuda:7'
    elif rank in range(36, 40):
        cuda_rank = 'cuda:8'
    elif rank in range(40, 44):
        cuda_rank = 'cuda:9'
    elif rank in range(44, 48):
        cuda_rank = 'cuda:10'
    elif rank in range(52, 56):
        cuda_rank = 'cuda:11'
    elif rank in range(60, 64):
        cuda_rank = 'cuda:12'
    elif rank in range(64, 68):
        cuda_rank = 'cuda:13'
    elif rank in range(68, 72):
        cuda_rank = 'cuda:14'
    else:
        cuda_rank = 'cuda:15'
